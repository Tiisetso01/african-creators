...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // 1. Email to the business owner (notification of lead)
    try {
      ...
      console.error('Owner email notification error:', ownerErr)
    }
    ...
    try {
      ...
      console.error('Client email confirmation error:', clientErr)
    }
